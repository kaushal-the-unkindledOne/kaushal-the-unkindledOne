...
public class Sound {
	...
	public Sound() {
		...
		soundURL[1] = getClass().getResource("/sound/fall.wav");
		soundURL[2] = getClass().getResource("/sound/heal.wav");
		soundURL[3] = getClass().getResource("/sound/teleport.wav");
		soundURL[4] = getClass().getResource("/sound/unlock.wav");
		soundURL[5] = getClass().getResource("/sound/hitmonster.wav");
		soundURL[6] = getClass().getResource("/sound/receivedamage.wav");
		soundURL[7] = getClass().getResource("/sound/swinging.wav");
		...
		soundURL[14] = getClass().getResource("/sound/gameover1.wav");
		...
		soundURL[19] = getClass().getResource("/sound/voice.wav");
		soundURL[20] = getClass().getResource("/sound/Merchant.wav");
		soundURL[21] = getClass().getResource("/sound/Dungeon.wav");
		soundURL[22] = getClass().getResource("/sound/chipwall.wav");
		soundURL[23] = getClass().getResource("/sound/dooropen.wav");
		soundURL[24] = getClass().getResource("/sound/bosstheme.wav");
		soundURL[25] = getClass().getResource("/sound/fanfare.wav");
		soundURL[26] = getClass().getResource("/sound/BlueBoyAdventure.wav");
	}
