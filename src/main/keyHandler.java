...
public keyHandler(GamePanel gp ) {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        // DIALOUGE STATE
        else if(gp.gameState == gp.dialougeState || gp.gameState == gp.cutsceneState) { dialougeState(code); }
        	
       //CHARACTER SCREEN STATE
        else if(gp.gameState == gp.characterScreenState) { characterScreenState(code); }
...
//            		gp.playSE(0);
	        ...
	        if(code == KeyEvent.VK_S){
	         ...
	         if(code == KeyEvent.VK_ENTER) {
	            	if(gp.ui.commandNum == 0) {
	            		System.out.println("BONK BUILD GO BRRRRR");
	            		gp.gameState = gp.playState;
	            	}
   ...
   public void pauseState(int code) {
    ...
    public void dialougeState(int code) {
     ...
     public void characterScreenState(int code) {
